...
impl From<LC<components::PreformattedText>> for PreformattedText {
    fn from(lc: LC<components::PreformattedText>) -> Self {
        Self {
            region: Region::from(lc.region),
            language: lc.component.lang,
            metadata: lc.component.metadata,
